...
export const CoreServiceCard = ({ title, description, Icon, index }: Props) => {
  return (
    <article
      className={cn(
        "autoShowRight flex h-[21.875rem] flex-1 flex-col rounded-md border border-bline bg-card p-10 pl-6 pt-36",
